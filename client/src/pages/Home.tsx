  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main id="top">
        ...
        <section id="field-of-interest" className="bg-[#f7f3ea] pb-4 pt-2 sm:pb-5 sm:pt-3 md:pb-6 md:pt-4">
          <div className="container"><div className="max-w-4xl"><h2 className="section-heading text-primary">Field of Interest</h2><ul className="mt-3 grid gap-3 text-sm leading-6 text-primary sm:grid-cols-2"><li className="flex items-start gap-3"><span className="academic-marker mt-2" aria-hidden="true" /><span>Machine Learning</span></li><li className="flex items-start gap-3"><span className="academic-marker mt-2" aria-hidden="true" /><span>Computer Vision</span></li><li className="flex items-start gap-3"><span className="academic-marker mt-2" aria-hidden="true" /><span>Large Language Model</span></li><li className="flex items-start gap-3"><span className="academic-marker mt-2" aria-hidden="true" /><span>IoT Automation</span></li><li className="flex items-start gap-3"><span className="academic-marker mt-2" aria-hidden="true" /><span>Web Development</span></li></ul></div></div>
        </section>

        <section id="employment-history" className="section-boundary bg-[#f1ece2] pt-2 pb-4 text-foreground sm:pt-3 sm:pb-5 md:pt-5 md:pb-7">
        ...
        <section id="academic-background" className="section-boundary bg-[#f7f3ea] pt-2 pb-4 sm:pt-3 sm:pb-5 md:pt-5 md:pb-7">
          <div className="container grid gap-5 sm:gap-6 lg:grid-cols-[0.35fr_0.65fr] lg:gap-10">
        ...
        <section id="publications" className="section-boundary bg-[#f1ece2] pt-2 pb-4 sm:pt-3 sm:pb-5 md:pt-5 md:pb-7">
          <div className="container grid gap-5 sm:gap-6 lg:grid-cols-[0.35fr_0.65fr] lg:gap-10">
        ...
        <section id="skills" className="section-boundary bg-[#f7f3ea] pt-2 pb-3 sm:pt-3 sm:pb-4 md:pt-4 md:pb-6">
          <div className="container grid gap-5 sm:gap-6 lg:grid-cols-[0.35fr_0.65fr] lg:gap-10">
