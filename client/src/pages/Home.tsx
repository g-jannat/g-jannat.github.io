  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main id="top">
        ...
        <section id="field-of-interest" className="bg-[#f1ece2] pb-4 pt-2 sm:pb-5 sm:pt-3 md:pb-6 md:pt-4">
          <div className="container"><div className="max-w-2xl"><h2 className="section-heading text-primary" style={{ fontSize: '1.5rem' }}>Field of Interest</h2><ul className="mt-3 grid gap-3 text-sm leading-6 text-primary sm:grid-cols-2"><li className="flex items-start gap-3"><span className="academic-marker mt-2" aria-hidden="true" /><span>Machine Learning </span></li><li className="flex items-start gap-3"><span className="academic-marker mt-2" aria-hidden="true" /><span>Computer Vision </span></li><li className="flex items-start gap-3"><span className="academic-marker mt-2" aria-hidden="true" /><span>Large Language Model </span></li><li className="flex items-start gap-3"><span className="academic-marker mt-2" aria-hidden="true" /><span>IoT Automation</span></li><li className="flex items-start gap-3"><span className="academic-marker mt-2" aria-hidden="true" /><span>Web Development</span></li></ul></div></div>
        </section>
